...
[![Linux Build Status](https://travis-ci.org/r-hub/crandb.svg?branch=master)](https://travis-ci.org/r-hub/crandb)
[![Windows Build status](https://ci.appveyor.com/api/projects/status/github/r-hub/crandb?svg=true)](https://ci.appveyor.com/project/gaborcsardi/crandb)
